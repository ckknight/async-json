(function(exports, undefined) {
  ...
  function stringifyAux(data, callback, key, counter, context) {
    switch (typeof data) {
      case "undefined":
      ...
      case "function":
        if (data.length === 0) {
          ...
          stringify(data.call(context), callback, key, counter, undefined);
        } else {
  ...
  function stringify(data, callback, key, counter, context) {
    if (!counter) {
      throw new Error("Expected counter");
    }
    try {
      stringifyAux(data, callback, key, counter, context);
    } catch (err) {
      callback(err);
    }
  }
  ...
  function runStringify(data, callback) {
    asap(function() {
      stringify(data, callback, undefined, new Counter(), undefined);
    });
  }
